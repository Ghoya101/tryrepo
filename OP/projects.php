...
?>
<link rel="stylesheet" href="../css/oprprojects.css">	


<form class="side"	>
<input type=button id="" STYLE="WIDTH:100%;box-sizing: none;" class="rc-button rc-button-submit" Onclick="window.location.href='payroll.php'" value="PAYROLL RECORDS">
<input type=text  STYLE="WIDTH:100%;BACKGROUND:None;  -webkit-box-shadow:none; text-shadow:none;outline:none;font-weight:bold;padding:2px;" value="-PCF RECORDS-" DISABLED>
<input type=button STYLE="WIDTH:100%;margin:0;" class="rc-button rc-button-submit" onclick="window.location.href='projects.php'" value="SENT PCF">
...
<td colspan=5>
<input type=button id="proj" STYLE="WIDTH:25%;border-right:1px solid #4787ed;border-left:1px solid #4787ed;border-top:1px solid #4787ed;" class="rc-button rc-button-submit" Onclick="window.location.href='newpo.php?proj=<?php echo $project;?>&&poid=<?php echo $NEWPO;?>'" value="+ NEW PCF">
<input type=button id="" STYLE="WIDTH:25%;border-right:1px solid #4787ed;border-left:1px solid #4787ed;border-top:1px solid #4787ed;" class="rc-button rc-button-submit" Onclick="window.location.href='payroll.php?proj=<?php echo $project;?>'" value="VIEW PROJECT PAYROLL">
<input type=button id="" STYLE="WIDTH:25%;border-right:1px solid #4787ed;border-left:1px solid #4787ed;border-top:1px solid #4787ed;" class="rc-button rc-button-submit" Onclick="window.location.href='new_monitoring.php?proj=<?php echo $project;?>'" value="PROJECT REQUIREMENTS">
</td>
</tr>

<tr class="setproj-tr1">
<td style="width:10%">PCF #</td>
...
$query4	= "SELECT * from sms_pcf WHERE PROJID = '$project' AND PREPAREDBY = $empid ORDER BY PREPAREDDATE DESC;";
...
<td colspan=5>NO PCF FOR THIS PROJECT.</td>
</tr>
<?php
}//7
else
...
<td colspan=6 style="font-weight:bold;padding:5px;text-align:center;">SENT PCF REPLENISHMENT</td>
</td>
</tr>

<tr class="nosetproj-tr1">
<td style="width:15%">PROJECT</td>
<td style="width:5%">PCF #</td>
<td style="width:40%">PAYEE</td>
...
?>
<tr>
<td colspan=5>YOU HAVE NO PCF RECORDS SENT.</td>
</tr>
