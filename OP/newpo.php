...
<tr class="tbl_trpo">
<th class="th1-po" colspan=2>ACTIONS</th>
<th class="th1-po">ITEM NO</th>
<th class="th1-po">DESCRIPTION</th>
<th class="th1-po">QTY</th>
<th class="th1-po">UNIT</th>
<th class="th1-po">UNIT PRICE</th>
<th class="th1-po">AMOUNT</th>
...
If(!isset($_GET['edititem']))
{
	...
	$TOTAL 	+= $t;
?>
<tr class="editcon" style="width:100%; margin:0;">
<input type=hidden name="co" id="coid" value="<?php echo $COID;?>"/>
<td style="width:5%;"class="tdc" style="font-size:14px;"><input type=button value="DEL" CLASS="btn-delitem" onclick="delitem('<?php echo $COID;?>','<?php echo $DESC;?>')"></td>
<td class="tdc" style="font-size:14px;"><input type=button value="EDIT" CLASS="btn-delitem" onclick="edititem('<?php echo $COID;?>','<?php echo $DESC;?>')"></td>
<td class="tdc" style="font-size:14px;" id="ids"><?php echo $x;?></td>
<td class="tdl" style="font-size:14px;" id="codesc"><?php echo $DESC;?></td>
<td 	class="tdr" style="font-size:14px;"><?php echo $QTY;?></td>
<td 	class="tdr" style="font-size:14px;"><?php echo $UNIT;?></td>
<td 	class="tdr" style="font-size:14px;"><?php echo $PRICE;?></td>
<td 	class="tdr" style="font-size:14px;"><?php echo $TPRICE;?></td>
</tr>
<?PHP
$x++;$i++;
}
...
<input style="width: 10%;" type="button" value="SEND" name="" onclick="history.back()" class="rc-button rc-button-submit"/>
