...
<br>
<input style="width: 10%;padding:5px; font-size:16px;font-weight:bold;float:right;" type="button" onclick="recommend('<?php echo $PO;?>','<?php echo $empid;?>')" value="RECOMMEND" class="rc-button rc-button-submit" >

</form>

<script>
function recommend(p,e)
{
var pr = p;
var em = e;
var a ="recommend.php?poid="+pr+"&&emp="+em;
