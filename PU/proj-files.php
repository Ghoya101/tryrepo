...
<!--<input class="nav-proj" type=button value="Costing" Onclick="window.location.href='addcostestimate.php?proj=<?php echo $proj;?>'">-->
<input class="nav-proj" type=button value="Purchase Orders" Onclick="window.location.href='po.php?proj=<?php echo $proj;?>'">
