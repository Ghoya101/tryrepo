...
<form class="po-form" Method="POST" action="">
...
<br>
<input style="width: 30%;padding:5px; font-size:16px;font-weight:bold;float:right;" type="button" onclick="approve('<?php echo $PO;?>','<?php echo $empid;?>')" value="APPROVE FOR DISBURSEMENT" class="rc-button rc-button-submit" >

</form>

<script>
function approve(p,e)
{
var pr = p;
var em = e;
var a ="sa-approve.php?poid="+pr+"&&emp="+em;
